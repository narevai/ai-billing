...
const claudeOpus: ModelPricingItem = {
...
const minimaxDiscounted: ModelPricingItem = {
  model_id: 'MiniMax-M2',
  provider_id: 'minimax',
  pricing: {
    prompt: 3e-7,
...
const qwenThinking: ModelPricingItem = {
...
const freeModel: ModelPricingItem = {
...
const sampleModels: ModelPricingItem[] = [
  claudeSonnet,
  claudeOpus,
  minimaxDiscounted,
  qwenThinking,
