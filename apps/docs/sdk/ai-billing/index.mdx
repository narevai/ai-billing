...
<CardGroup cols={2}>
  <Card title="Core primitives" icon="boxes-stacked" href="/sdk/ai-billing/reference/core/typedoc/index">
    Shared billing types, price resolvers, and destination helpers in `@ai-billing/core`.
  </Card>
  <Card title="API reference" icon="book-open" href="/sdk/ai-billing/reference/core/typedoc/index">
