...
[@ai-billing/mistral](/sdk/ai-billing/reference/mistral/typedoc/index) / MistralV3MiddlewareOptions

# Interface: MistralV3MiddlewareOptions\<TTags\>

Defined in: [mistral/src/ai-sdk/language-model-middleware/v3/language-model-v3-mistral-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/mistral/src/ai-sdk/language-model-middleware/v3/language-model-v3-mistral-billing-middleware.ts#L46)

Configuration for [createMistralV3Middleware](/sdk/ai-billing/reference/mistral/typedoc/functions/createMistralV3Middleware).
...
Defined in: [mistral/src/ai-sdk/language-model-middleware/v3/language-model-v3-mistral-billing-middleware.ts:49](https://github.com/narevai/ai-billing/blob/main/packages/mistral/src/ai-sdk/language-model-middleware/v3/language-model-v3-mistral-billing-middleware.ts#L49)
