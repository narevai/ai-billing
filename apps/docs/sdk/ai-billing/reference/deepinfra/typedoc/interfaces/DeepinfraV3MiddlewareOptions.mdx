...
[@ai-billing/deepinfra](/sdk/ai-billing/reference/deepinfra/typedoc/index) / DeepinfraV3MiddlewareOptions

# Interface: DeepinfraV3MiddlewareOptions\<TTags\>

Defined in: [deepinfra/src/ai-sdk/language-model-middleware/v3/language-model-v3-deepinfra-billing-middleware.ts:53](https://github.com/narevai/ai-billing/blob/main/packages/deepinfra/src/ai-sdk/language-model-middleware/v3/language-model-v3-deepinfra-billing-middleware.ts#L53)

Configuration for [createDeepinfraV3Middleware](/sdk/ai-billing/reference/deepinfra/typedoc/functions/createDeepinfraV3Middleware).
...
Defined in: [deepinfra/src/ai-sdk/language-model-middleware/v3/language-model-v3-deepinfra-billing-middleware.ts:56](https://github.com/narevai/ai-billing/blob/main/packages/deepinfra/src/ai-sdk/language-model-middleware/v3/language-model-v3-deepinfra-billing-middleware.ts#L56)
