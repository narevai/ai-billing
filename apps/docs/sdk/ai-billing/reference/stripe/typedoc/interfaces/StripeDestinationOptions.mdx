...
[@ai-billing/stripe](/sdk/ai-billing/reference/stripe/typedoc/index) / StripeDestinationOptions
...
Options for [createStripeDestination](/sdk/ai-billing/reference/stripe/typedoc/functions/createStripeDestination).
...
- always includes `value` (cost in nanos; requires a defined BillingEvent.cost on each event)
  and `stripe_customer_id` (from tags; see [createStripeDestination](/sdk/ai-billing/reference/stripe/typedoc/functions/createStripeDestination) for missing-tag behavior)
