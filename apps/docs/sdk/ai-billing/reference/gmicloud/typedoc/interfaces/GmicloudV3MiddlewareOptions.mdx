...
[@ai-billing/gmicloud](/sdk/ai-billing/reference/gmicloud/typedoc/index) / GmicloudV3MiddlewareOptions

# Interface: GmicloudV3MiddlewareOptions\<TTags\>

Defined in: [gmicloud/src/ai-sdk/language-model-middleware/v3/language-model-v3-gmicloud-billing-middleware.ts:43](https://github.com/narevai/ai-billing/blob/main/packages/gmicloud/src/ai-sdk/language-model-middleware/v3/language-model-v3-gmicloud-billing-middleware.ts#L43)

Configuration for [createGmicloudV3Middleware](/sdk/ai-billing/reference/gmicloud/typedoc/functions/createGmicloudV3Middleware).
...
Defined in: [gmicloud/src/ai-sdk/language-model-middleware/v3/language-model-v3-gmicloud-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/gmicloud/src/ai-sdk/language-model-middleware/v3/language-model-v3-gmicloud-billing-middleware.ts#L46)
