...
[@ai-billing/gmicloud](/sdk/ai-billing/reference/gmicloud/typedoc/index) / GmicloudV4MiddlewareOptions

# Interface: GmicloudV4MiddlewareOptions\<TTags\>

Defined in: [gmicloud/src/ai-sdk/language-model-middleware/v4/language-model-v4-gmicloud-billing-middleware.ts:43](https://github.com/narevai/ai-billing/blob/main/packages/gmicloud/src/ai-sdk/language-model-middleware/v4/language-model-v4-gmicloud-billing-middleware.ts#L43)

Configuration for [createGmicloudV4Middleware](/sdk/ai-billing/reference/gmicloud/typedoc/functions/createGmicloudV4Middleware).
...
Defined in: [gmicloud/src/ai-sdk/language-model-middleware/v4/language-model-v4-gmicloud-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/gmicloud/src/ai-sdk/language-model-middleware/v4/language-model-v4-gmicloud-billing-middleware.ts#L46)
