...
[@ai-billing/gateway](/sdk/ai-billing/reference/gateway/typedoc/index) / GatewayV3MiddlewareOptions
...
Configuration for [createGatewayV3Middleware](/sdk/ai-billing/reference/gateway/typedoc/functions/createGatewayV3Middleware).
