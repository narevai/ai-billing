...
[@ai-billing/zai](/sdk/ai-billing/reference/zai/typedoc/index) / ZaiV4MiddlewareOptions

# Interface: ZaiV4MiddlewareOptions\<TTags\>

Defined in: [zai/src/ai-sdk/language-model-middleware/v4/language-model-v4-zai-billing-middleware.ts:37](https://github.com/narevai/ai-billing/blob/main/packages/zai/src/ai-sdk/language-model-middleware/v4/language-model-v4-zai-billing-middleware.ts#L37)

Configuration for [createZaiV4Middleware](/sdk/ai-billing/reference/zai/typedoc/functions/createZaiV4Middleware).
...
Defined in: [zai/src/ai-sdk/language-model-middleware/v4/language-model-v4-zai-billing-middleware.ts:40](https://github.com/narevai/ai-billing/blob/main/packages/zai/src/ai-sdk/language-model-middleware/v4/language-model-v4-zai-billing-middleware.ts#L40)
