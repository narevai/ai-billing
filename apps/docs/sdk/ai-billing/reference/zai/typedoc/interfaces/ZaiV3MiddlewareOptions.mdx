...
[@ai-billing/zai](/sdk/ai-billing/reference/zai/typedoc/index) / ZaiV3MiddlewareOptions

# Interface: ZaiV3MiddlewareOptions\<TTags\>

Defined in: [zai/src/ai-sdk/language-model-middleware/v3/language-model-v3-zai-billing-middleware.ts:37](https://github.com/narevai/ai-billing/blob/main/packages/zai/src/ai-sdk/language-model-middleware/v3/language-model-v3-zai-billing-middleware.ts#L37)

Configuration for [createZaiV3Middleware](/sdk/ai-billing/reference/zai/typedoc/functions/createZaiV3Middleware).
...
Defined in: [zai/src/ai-sdk/language-model-middleware/v3/language-model-v3-zai-billing-middleware.ts:40](https://github.com/narevai/ai-billing/blob/main/packages/zai/src/ai-sdk/language-model-middleware/v3/language-model-v3-zai-billing-middleware.ts#L40)
