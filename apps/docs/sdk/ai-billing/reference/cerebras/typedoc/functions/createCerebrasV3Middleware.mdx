...
Defined in: [cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts:95](https://github.com/narevai/ai-billing/blob/main/packages/cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts#L95)
