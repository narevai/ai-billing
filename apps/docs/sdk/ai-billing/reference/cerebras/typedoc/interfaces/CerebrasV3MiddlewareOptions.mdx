...
[@ai-billing/cerebras](/sdk/ai-billing/reference/cerebras/typedoc/index) / CerebrasV3MiddlewareOptions

# Interface: CerebrasV3MiddlewareOptions\<TTags\>

Defined in: [cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts:44](https://github.com/narevai/ai-billing/blob/main/packages/cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts#L44)

Configuration for [createCerebrasV3Middleware](/sdk/ai-billing/reference/cerebras/typedoc/functions/createCerebrasV3Middleware).
...
Defined in: [cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts:47](https://github.com/narevai/ai-billing/blob/main/packages/cerebras/src/ai-sdk/language-model-middleware/v3/language-model-v3-cerebras-billing-middleware.ts#L47)
