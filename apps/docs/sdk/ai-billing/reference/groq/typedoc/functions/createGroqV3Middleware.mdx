...
[@ai-billing/groq](/sdk/ai-billing/reference/groq/typedoc/index) / createGroqV3Middleware
...
[`GroqV3MiddlewareOptions`](/sdk/ai-billing/reference/groq/typedoc/interfaces/GroqV3MiddlewareOptions)\<`TTags`\>

Billing options; see [GroqV3MiddlewareOptions](/sdk/ai-billing/reference/groq/typedoc/interfaces/GroqV3MiddlewareOptions). A `priceResolver` is required
