...
Defined in: [groq/src/ai-sdk/language-model-middleware/v3/language-model-v3-groq-billing-middleware.ts:94](https://github.com/narevai/ai-billing/blob/main/packages/groq/src/ai-sdk/language-model-middleware/v3/language-model-v3-groq-billing-middleware.ts#L94)
