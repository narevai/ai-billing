...
[@ai-billing/fireworks](/sdk/ai-billing/reference/fireworks/typedoc/index) / FireworksV3MiddlewareOptions

# Interface: FireworksV3MiddlewareOptions\<TTags\>

Defined in: [fireworks/src/ai-sdk/language-model-middleware/v3/language-model-v3-fireworks-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/fireworks/src/ai-sdk/language-model-middleware/v3/language-model-v3-fireworks-billing-middleware.ts#L46)

Configuration for [createFireworksV3Middleware](/sdk/ai-billing/reference/fireworks/typedoc/functions/createFireworksV3Middleware).
...
Defined in: [fireworks/src/ai-sdk/language-model-middleware/v3/language-model-v3-fireworks-billing-middleware.ts:49](https://github.com/narevai/ai-billing/blob/main/packages/fireworks/src/ai-sdk/language-model-middleware/v3/language-model-v3-fireworks-billing-middleware.ts#L49)
