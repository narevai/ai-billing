...
[@ai-billing/fireworks](/sdk/ai-billing/reference/fireworks/typedoc/index) / FireworksV4MiddlewareOptions

# Interface: FireworksV4MiddlewareOptions\<TTags\>

Defined in: [fireworks/src/ai-sdk/language-model-middleware/v4/language-model-v4-fireworks-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/fireworks/src/ai-sdk/language-model-middleware/v4/language-model-v4-fireworks-billing-middleware.ts#L46)

Configuration for [createFireworksV4Middleware](/sdk/ai-billing/reference/fireworks/typedoc/functions/createFireworksV4Middleware).
...
Defined in: [fireworks/src/ai-sdk/language-model-middleware/v4/language-model-v4-fireworks-billing-middleware.ts:49](https://github.com/narevai/ai-billing/blob/main/packages/fireworks/src/ai-sdk/language-model-middleware/v4/language-model-v4-fireworks-billing-middleware.ts#L49)
