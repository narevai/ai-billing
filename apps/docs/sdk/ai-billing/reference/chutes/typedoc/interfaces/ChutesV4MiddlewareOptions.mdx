...
[@ai-billing/chutes](/sdk/ai-billing/reference/chutes/typedoc/index) / ChutesV4MiddlewareOptions

# Interface: ChutesV4MiddlewareOptions\<TTags\>

Defined in: [chutes/src/ai-sdk/language-model-middleware/v4/language-model-v4-chutes-billing-middleware.ts:24](https://github.com/narevai/ai-billing/blob/main/packages/chutes/src/ai-sdk/language-model-middleware/v4/language-model-v4-chutes-billing-middleware.ts#L24)

Configuration for [createChutesV4Middleware](/sdk/ai-billing/reference/chutes/typedoc/functions/createChutesV4Middleware).
...
Defined in: [chutes/src/ai-sdk/language-model-middleware/v4/language-model-v4-chutes-billing-middleware.ts:27](https://github.com/narevai/ai-billing/blob/main/packages/chutes/src/ai-sdk/language-model-middleware/v4/language-model-v4-chutes-billing-middleware.ts#L27)
