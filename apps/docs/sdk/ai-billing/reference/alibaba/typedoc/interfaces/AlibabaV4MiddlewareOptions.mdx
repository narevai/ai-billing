...
[@ai-billing/alibaba](/sdk/ai-billing/reference/alibaba/typedoc/index) / AlibabaV4MiddlewareOptions

# Interface: AlibabaV4MiddlewareOptions\<TTags\>

Defined in: [alibaba/src/ai-sdk/language-model-middleware/v4/language-model-v4-alibaba-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/alibaba/src/ai-sdk/language-model-middleware/v4/language-model-v4-alibaba-billing-middleware.ts#L46)

Configuration for [createAlibabaV4Middleware](/sdk/ai-billing/reference/alibaba/typedoc/functions/createAlibabaV4Middleware).
...
Defined in: [alibaba/src/ai-sdk/language-model-middleware/v4/language-model-v4-alibaba-billing-middleware.ts:49](https://github.com/narevai/ai-billing/blob/main/packages/alibaba/src/ai-sdk/language-model-middleware/v4/language-model-v4-alibaba-billing-middleware.ts#L49)
