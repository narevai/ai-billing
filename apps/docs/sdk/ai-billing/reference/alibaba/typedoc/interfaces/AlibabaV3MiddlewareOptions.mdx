...
[@ai-billing/alibaba](/sdk/ai-billing/reference/alibaba/typedoc/index) / AlibabaV3MiddlewareOptions

# Interface: AlibabaV3MiddlewareOptions\<TTags\>

Defined in: [alibaba/src/ai-sdk/language-model-middleware/v3/language-model-v3-alibaba-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/alibaba/src/ai-sdk/language-model-middleware/v3/language-model-v3-alibaba-billing-middleware.ts#L46)

Configuration for [createAlibabaV3Middleware](/sdk/ai-billing/reference/alibaba/typedoc/functions/createAlibabaV3Middleware).
...
Defined in: [alibaba/src/ai-sdk/language-model-middleware/v3/language-model-v3-alibaba-billing-middleware.ts:49](https://github.com/narevai/ai-billing/blob/main/packages/alibaba/src/ai-sdk/language-model-middleware/v3/language-model-v3-alibaba-billing-middleware.ts#L49)
