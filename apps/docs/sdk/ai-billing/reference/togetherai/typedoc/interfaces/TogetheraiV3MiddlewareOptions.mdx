...
[@ai-billing/togetherai](/sdk/ai-billing/reference/togetherai/typedoc/index) / TogetheraiV3MiddlewareOptions

# Interface: TogetheraiV3MiddlewareOptions\<TTags\>

Defined in: [togetherai/src/ai-sdk/language-model-middleware/v3/language-model-v3-togetherai-billing-middleware.ts:39](https://github.com/narevai/ai-billing/blob/main/packages/togetherai/src/ai-sdk/language-model-middleware/v3/language-model-v3-togetherai-billing-middleware.ts#L39)

Configuration for [createTogetheraiV3Middleware](/sdk/ai-billing/reference/togetherai/typedoc/functions/createTogetheraiV3Middleware).
...
Defined in: [togetherai/src/ai-sdk/language-model-middleware/v3/language-model-v3-togetherai-billing-middleware.ts:42](https://github.com/narevai/ai-billing/blob/main/packages/togetherai/src/ai-sdk/language-model-middleware/v3/language-model-v3-togetherai-billing-middleware.ts#L42)
