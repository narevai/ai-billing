...
Defined in: [language-model-middleware/v3/language-model-v3-openrouter-billing-middleware.ts:71](https://github.com/narevai/ai-billing/blob/main/packages/openrouter/src/ai-sdk/language-model-middleware/v3/language-model-v3-openrouter-billing-middleware.ts#L71)
