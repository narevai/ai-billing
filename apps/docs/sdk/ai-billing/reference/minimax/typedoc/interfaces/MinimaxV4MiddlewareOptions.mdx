...
[@ai-billing/minimax](/sdk/ai-billing/reference/minimax/typedoc/index) / MinimaxV4MiddlewareOptions

# Interface: MinimaxV4MiddlewareOptions\<TTags\>

Defined in: [minimax/src/ai-sdk/language-model-middleware/v4/language-model-v4-minimax-billing-middleware.ts:31](https://github.com/narevai/ai-billing/blob/main/packages/minimax/src/ai-sdk/language-model-middleware/v4/language-model-v4-minimax-billing-middleware.ts#L31)

Configuration for [createMinimaxV4Middleware](/sdk/ai-billing/reference/minimax/typedoc/functions/createMinimaxV4Middleware).
...
Defined in: [minimax/src/ai-sdk/language-model-middleware/v4/language-model-v4-minimax-billing-middleware.ts:34](https://github.com/narevai/ai-billing/blob/main/packages/minimax/src/ai-sdk/language-model-middleware/v4/language-model-v4-minimax-billing-middleware.ts#L34)
