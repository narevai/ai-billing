...
[@ai-billing/cohere](/sdk/ai-billing/reference/cohere/typedoc/index) / CohereV4MiddlewareOptions

# Interface: CohereV4MiddlewareOptions\<TTags\>

Defined in: [cohere/src/ai-sdk/language-model-middleware/v4/language-model-v4-cohere-billing-middleware.ts:51](https://github.com/narevai/ai-billing/blob/main/packages/cohere/src/ai-sdk/language-model-middleware/v4/language-model-v4-cohere-billing-middleware.ts#L51)

Configuration for [createCohereV4Middleware](/sdk/ai-billing/reference/cohere/typedoc/functions/createCohereV4Middleware).
...
Defined in: [cohere/src/ai-sdk/language-model-middleware/v4/language-model-v4-cohere-billing-middleware.ts:54](https://github.com/narevai/ai-billing/blob/main/packages/cohere/src/ai-sdk/language-model-middleware/v4/language-model-v4-cohere-billing-middleware.ts#L54)
