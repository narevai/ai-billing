...
[@ai-billing/huggingface](/sdk/ai-billing/reference/huggingface/typedoc/index) / HuggingfaceV3MiddlewareOptions

# Interface: HuggingfaceV3MiddlewareOptions\<TTags\>

Defined in: [huggingface/src/ai-sdk/language-model-middleware/v3/language-model-v3-huggingface-billing-middleware.ts:44](https://github.com/narevai/ai-billing/blob/main/packages/huggingface/src/ai-sdk/language-model-middleware/v3/language-model-v3-huggingface-billing-middleware.ts#L44)

Configuration for [createHuggingfaceV3Middleware](/sdk/ai-billing/reference/huggingface/typedoc/functions/createHuggingfaceV3Middleware).
...
Defined in: [huggingface/src/ai-sdk/language-model-middleware/v3/language-model-v3-huggingface-billing-middleware.ts:47](https://github.com/narevai/ai-billing/blob/main/packages/huggingface/src/ai-sdk/language-model-middleware/v3/language-model-v3-huggingface-billing-middleware.ts#L47)
