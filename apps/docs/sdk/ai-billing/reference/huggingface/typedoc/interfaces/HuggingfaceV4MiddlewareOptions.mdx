...
[@ai-billing/huggingface](/sdk/ai-billing/reference/huggingface/typedoc/index) / HuggingfaceV4MiddlewareOptions

# Interface: HuggingfaceV4MiddlewareOptions\<TTags\>

Defined in: [huggingface/src/ai-sdk/language-model-middleware/v4/language-model-v4-huggingface-billing-middleware.ts:44](https://github.com/narevai/ai-billing/blob/main/packages/huggingface/src/ai-sdk/language-model-middleware/v4/language-model-v4-huggingface-billing-middleware.ts#L44)

Configuration for [createHuggingfaceV4Middleware](/sdk/ai-billing/reference/huggingface/typedoc/functions/createHuggingfaceV4Middleware).
...
Defined in: [huggingface/src/ai-sdk/language-model-middleware/v4/language-model-v4-huggingface-billing-middleware.ts:47](https://github.com/narevai/ai-billing/blob/main/packages/huggingface/src/ai-sdk/language-model-middleware/v4/language-model-v4-huggingface-billing-middleware.ts#L47)
