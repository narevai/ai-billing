...
[@ai-billing/xai](/sdk/ai-billing/reference/xai/typedoc/index) / XaiV4MiddlewareOptions

# Interface: XaiV4MiddlewareOptions\<TTags\>

Defined in: [xai/src/ai-sdk/language-model-middleware/v4/language-model-v4-xai-billing-middleware.ts:43](https://github.com/narevai/ai-billing/blob/main/packages/xai/src/ai-sdk/language-model-middleware/v4/language-model-v4-xai-billing-middleware.ts#L43)

Configuration for [createXaiV4Middleware](/sdk/ai-billing/reference/xai/typedoc/functions/createXaiV4Middleware).
...
Defined in: [xai/src/ai-sdk/language-model-middleware/v4/language-model-v4-xai-billing-middleware.ts:46](https://github.com/narevai/ai-billing/blob/main/packages/xai/src/ai-sdk/language-model-middleware/v4/language-model-v4-xai-billing-middleware.ts#L46)
