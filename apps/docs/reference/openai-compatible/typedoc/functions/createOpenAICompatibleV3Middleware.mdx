...
[@ai-billing/openai-compatible](../index) / createOpenAICompatibleV3Middleware
...
[`OpenAICompatibleV3MiddlewareOptions`](../interfaces/OpenAICompatibleV3MiddlewareOptions)\<`TTags`\>

Billing options; see [OpenAICompatibleV3MiddlewareOptions](../interfaces/OpenAICompatibleV3MiddlewareOptions).
