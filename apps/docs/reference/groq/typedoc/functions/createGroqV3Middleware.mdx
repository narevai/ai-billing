...
[`GroqV3MiddlewareOptions`](../interfaces/GroqV3MiddlewareOptions)\<`TTags`\>

Billing options; see [GroqV3MiddlewareOptions](../interfaces/GroqV3MiddlewareOptions). A `priceResolver` is required
