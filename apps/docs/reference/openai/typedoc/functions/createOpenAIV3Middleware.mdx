...
[@ai-billing/openai](../index) / createOpenAIV3Middleware
...
[`OpenAIV3MiddlewareOptions`](../interfaces/OpenAIV3MiddlewareOptions)\<`TTags`\>

Billing options; see [OpenAIV3MiddlewareOptions](../interfaces/OpenAIV3MiddlewareOptions).
