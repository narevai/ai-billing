...
[@ai-billing/gateway](../index) / createGatewayV3Middleware
...
[`GatewayV3MiddlewareOptions`](../interfaces/GatewayV3MiddlewareOptions)\<`TTags`\>

Shared billing options; see [GatewayV3MiddlewareOptions](../interfaces/GatewayV3MiddlewareOptions) for what you can pass and
