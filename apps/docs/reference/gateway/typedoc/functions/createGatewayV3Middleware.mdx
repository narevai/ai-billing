...
Defined in: [language-model-middleware/v3/language-model-v3-ai-gateway-billing-middleware.ts:101](https://github.com/narevai/ai-billing/blob/main/packages/gateway/src/ai-sdk/language-model-middleware/v3/language-model-v3-ai-gateway-billing-middleware.ts#L101)
...
`GatewayMiddlewareOptions`\<`TTags`\>

Shared billing options; see GatewayMiddlewareOptions for what you can pass and
