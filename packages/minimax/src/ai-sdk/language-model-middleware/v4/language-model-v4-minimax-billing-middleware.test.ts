...
import { createMinimaxV4Middleware } from './language-model-v4-minimax-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('MinimaxBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event', async () => {
      ...
      const middleware = createMinimaxV4Middleware({
