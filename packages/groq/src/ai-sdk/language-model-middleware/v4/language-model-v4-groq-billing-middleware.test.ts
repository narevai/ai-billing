...
import { createGroqV4Middleware } from './language-model-v4-groq-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('GroqBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event', async () => {
      ...
      const middleware = createGroqV4Middleware({
