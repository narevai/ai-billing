...
type GoogleVertexProviderMetadata = SharedV3ProviderMetadata & {
  vertex?: { usageMetadata: GoogleVertexUsageAccounting };
};

/**
 * Configuration for {@link createGoogleVertexV3Middleware}.
 *
 ...
 */
export interface GoogleVertexV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link GoogleVertexV3MiddlewareOptions}.
 * @returns A V3 billing middleware instance for Google Vertex AI.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createGoogleVertexV3Middleware<TTags extends DefaultTags>(
  options: GoogleVertexV3MiddlewareOptions<TTags>,
) {
