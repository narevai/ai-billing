...
export interface ZaiV4UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createZaiV4Middleware}.
 *
 ...
 */
export interface ZaiV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link ZaiV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for Z.ai.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createZaiV4Middleware<TTags extends DefaultTags>(
  options: ZaiV4MiddlewareOptions<TTags>,
) {
  return createV4BillingMiddleware<TTags>({
    ...
    buildEvent: async ({
      ...
      const zaiRawUsage = usage?.raw as ZaiV4UsageAccounting | undefined;
