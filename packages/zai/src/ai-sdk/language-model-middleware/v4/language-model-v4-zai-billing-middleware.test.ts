...
import {
  ...
  ZaiV4UsageAccounting,
} from './language-model-v4-zai-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('ZaiBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generate-text usage', async () => {
      ...
      const middleware = createZaiV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as ZaiV4UsageAccounting;
