 ...
 *
 * Google includes reasoning tokens in the completion count, so they are subtracted before billing
 * the base completion rate and billed separately at the reasoning rate.
 *
