...
type GoogleProviderMetadata = SharedV4ProviderMetadata & {
  google?: { usageMetadata: GoogleUsageAccounting };
};

/**
 * Configuration for {@link createGoogleV4Middleware}.
 *
 ...
 */
export interface GoogleV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link GoogleV4MiddlewareOptions}.
 * @returns A V4 billing middleware instance for Google.
 *
 * @example
 ...
 * import { createGoogleV4Middleware } from '@ai-billing/google/v4';
 * import {
 *   consoleDestination,
 ...
 * ```
 */
export function createGoogleV4Middleware<TTags extends DefaultTags>(
  options: GoogleV4MiddlewareOptions<TTags>,
) {
