 ...
 *   not `7`).
 */
export interface CohereV3UsageAccounting extends JSONObject {
  billed_units?: {
...
/**
 * Configuration for {@link createCohereV3Middleware}.
 *
 ...
 */
export interface CohereV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link CohereV3MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V3 billing middleware instance for Cohere.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createCohereV3Middleware<TTags extends DefaultTags>(
  options: CohereV3MiddlewareOptions<TTags>,
) {
  return createV3BillingMiddleware<TTags>({
    ...
    buildEvent: async ({
      ...
      const cohereRawUsage = usage?.raw as CohereV3UsageAccounting | undefined;
