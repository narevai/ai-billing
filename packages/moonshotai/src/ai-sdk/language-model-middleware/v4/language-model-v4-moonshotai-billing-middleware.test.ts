...
import {
  createMoonshotaiV4Middleware,
  MoonshotaiV4UsageAccounting,
} from './language-model-v4-moonshotai-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('MoonshotaiBillingMiddlewareV4 Integration', () => {
  ...
  const createResult = (
    ...
    usage: {
      ...
      } as MoonshotaiV4UsageAccounting,
    },
