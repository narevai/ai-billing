...
/**
 * Configuration for {@link createChutesV4Middleware}.
 *
 ...
 */
export interface ChutesV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link ChutesV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for Chutes.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createChutesV4Middleware<TTags extends DefaultTags>(
  options: ChutesV4MiddlewareOptions<TTags>,
) {
