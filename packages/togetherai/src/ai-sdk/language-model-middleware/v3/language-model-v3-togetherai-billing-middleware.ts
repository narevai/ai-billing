...
export interface TogetheraiV3UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createTogetheraiV3Middleware}.
 *
 ...
 */
export interface TogetheraiV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link TogetheraiV3MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V3 billing middleware instance for Together AI.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createTogetheraiV3Middleware<TTags extends DefaultTags>(
  options: TogetheraiV3MiddlewareOptions<TTags>,
) {
