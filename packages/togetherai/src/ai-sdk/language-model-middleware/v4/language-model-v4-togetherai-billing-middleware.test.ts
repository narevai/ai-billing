...
} from './language-model-v4-togetherai-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('TogetheraiBillingMiddlewareV4 Integration', () => {
  ...
  const createResult = (
    ...
    usage: {
      ...
      raw: {
        ...
        total_tokens: 110,
        reasoning_tokens: 0,
      } as TogetheraiV4UsageAccounting,
    },
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generate-text usage', async () => {
      ...
      const middleware = createTogetheraiV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as TogetheraiV4UsageAccounting;
