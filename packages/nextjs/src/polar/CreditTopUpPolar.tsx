...
export const CreditTopUpPolar = React.forwardRef<HTMLDivElement, CreditTopUpPolarProps>(
  ({ userId, title = 'Choose a credit bundle to top up your workspace balance.', className, style, ...props }, ref) => {
    ...
    return (
      <div ref={ref} className={cls} style={{ ...cardBase, display: 'flex', flexDirection: 'column', ...style }} {...props}>
