...
export interface XaiV4UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createXaiV4Middleware}.
 *
 ...
 */
export interface XaiV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link XaiV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for xAI.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createXaiV4Middleware<TTags extends DefaultTags>(
  options: XaiV4MiddlewareOptions<TTags>,
) {
  return createV4BillingMiddleware<TTags>({
    ...
    buildEvent: async ({
      ...
      const xaiRawUsage = usage?.raw as XaiV4UsageAccounting | undefined;
