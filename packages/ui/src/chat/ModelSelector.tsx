...
export interface ModelSelectorProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSelect'> {
  models: ModelOption[];
    ...
    return (
      ...
      >
        ...
        <div style={modelScrollArea}>
            ...
            <div key={provider}>
              ...
              {providerModels.map(m => (
                <button
                  ...
                  style={{
                    ...modelItemButton,
                    background: m.id === selectedModelId ? 'var(--muted)' : 'transparent',
          ...
          {filtered.length === 0 && (
            <div style={{ padding: '16px 14px', fontSize: '13px', color: 'var(--muted-foreground)' }}>
              No models found
            </div>
          )}
        </div>
