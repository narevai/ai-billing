...
describe('calculateHuggingfaceCost', () => {
  it('should return undefined if no pricing is provided', () => {
    const result = calculateHuggingfaceCost({
      pricing: undefined,
      usage: {
        promptTokens: 10,
        completionTokens: 10,
  ...
  it('should calculate cost for the sample Huggingface generate-text usage (input_tokens: 17, output_tokens: 8, cached_tokens: 0)', () => {
    const mockPricing: ModelPricing = {
  ...
  it('should deduct reasoning tokens from completion tokens correctly (speculative reasoning-model usage)', () => {
    const mockPricing: ModelPricing = {
