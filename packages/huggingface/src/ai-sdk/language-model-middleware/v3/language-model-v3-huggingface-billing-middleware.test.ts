...
import {
  createHuggingfaceV3Middleware,
  HuggingfaceV3UsageAccounting,
} from './language-model-v3-huggingface-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV3,
...
describe('HuggingfaceBillingMiddlewareV3 Integration', () => {
  ...
  const createResult = (
    ...
    usage: {
      ...
      raw: {
        ...
        total_tokens: 25,
      } as HuggingfaceV3UsageAccounting,
    },
    response: {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createHuggingfaceV3Middleware({
      ...
      const rawUsage = baseResult.usage.raw as HuggingfaceV3UsageAccounting;
