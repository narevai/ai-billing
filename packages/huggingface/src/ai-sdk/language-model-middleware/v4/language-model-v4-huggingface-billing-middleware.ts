 ...
 * totals.
 */
export interface HuggingfaceV4UsageAccounting extends JSONObject {
  input_tokens: number;
...
/**
 * Configuration for {@link createHuggingfaceV4Middleware}.
 *
 ...
 */
export interface HuggingfaceV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link HuggingfaceV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for Hugging Face.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createHuggingfaceV4Middleware<TTags extends DefaultTags>(
  options: HuggingfaceV4MiddlewareOptions<TTags>,
) {
