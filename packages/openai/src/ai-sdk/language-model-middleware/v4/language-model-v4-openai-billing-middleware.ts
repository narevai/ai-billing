...
type OpenAIProviderMetadata = SharedV4ProviderMetadata & {
  openai?: OpenAIUsageAccounting;
};

/**
 * Configuration for {@link createOpenAIV4Middleware}.
 *
 ...
 */
export interface OpenAIV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link OpenAIV4MiddlewareOptions}.
 ...
 * ```
 */
export function createOpenAIV4Middleware<TTags extends DefaultTags>(
  options: OpenAIV4MiddlewareOptions<TTags>,
) {
