...
import {
  createFireworksV4Middleware,
  FireworksV4UsageAccounting,
} from './language-model-v4-fireworks-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('FireworksBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generate-text usage from the issue', async () => {
      ...
      const middleware = createFireworksV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as FireworksV4UsageAccounting;
