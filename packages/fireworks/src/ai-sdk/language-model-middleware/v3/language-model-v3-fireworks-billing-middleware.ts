...
export interface FireworksV3UsageAccounting extends JSONObject {
   ...
   * one of them (see the extraction logic in {@link createFireworksV3Middleware}), never sum both, or
...
/**
 * Configuration for {@link createFireworksV3Middleware}.
 *
 ...
 */
export interface FireworksV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link FireworksV3MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V3 billing middleware instance for Fireworks.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createFireworksV3Middleware<TTags extends DefaultTags>(
  options: FireworksV3MiddlewareOptions<TTags>,
) {
