...
/**
 * Computes total cost for a Fireworks completion from {@link ModelPricing} and token usage.
 *
 ...
 * Reasoning tokens have no separate Fireworks pricing tier, so they are billed at the `completionTokens`
 * rate after being deducted from the completion total (reasoning tokens are a subset of `completionTokens`,
 * matching Fireworks' OpenAI-compatible usage payload).
 *
 ...
 * @internal
 */
export const calculateFireworksCost = (params: {
