...
export interface DeepinfraV4UsageAccounting extends JSONObject {
   ...
   * `usage.rawProviderCost` (see {@link createDeepinfraV4Middleware}) but is never used as the billed
...
/**
 * Configuration for {@link createDeepinfraV4Middleware}.
 *
 ...
 */
export interface DeepinfraV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link DeepinfraV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for DeepInfra.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createDeepinfraV4Middleware<TTags extends DefaultTags>(
  options: DeepinfraV4MiddlewareOptions<TTags>,
) {
