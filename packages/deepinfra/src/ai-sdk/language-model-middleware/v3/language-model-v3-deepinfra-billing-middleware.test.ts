...
import {
  createDeepinfraV3Middleware,
  DeepinfraV3UsageAccounting,
} from './language-model-v3-deepinfra-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV3,
...
describe('DeepinfraBillingMiddlewareV3 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createDeepinfraV3Middleware({
      ...
      const rawUsage = baseResult.usage.raw as DeepinfraV3UsageAccounting;
