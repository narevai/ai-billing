...
import { createV4BillingMiddleware } from './language-model-v4-base-billing-middleware.js';
import {
...
describe('createV4BillingMiddleware', () => {
  const StrictBillingEventSchema: z.ZodType<BillingEvent> = BillingEventSchema;
  const testParams: LanguageModelV4CallOptions = {
    prompt: [],
  };
  ...
  describe('wrapGenerate', () => {
    it('should pass webSearchCount=0 to buildEvent when content has no sources', async () => {
      ...
      const middleware = createV4BillingMiddleware({
    ...
    it('should properly merge defaultTags and providerOptions', async () => {
      ...
      const paramsWithProviderOptions: LanguageModelV4CallOptions = {
        ...testParams,
        providerOptions: {
  ...
  describe('wrapStream', () => {
    ...
    it('should extract providerMetadata from the finish chunk', async () => {
      ...
      const mockMetadata: SharedV4ProviderMetadata = {
