...
export interface PerplexityV3UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createPerplexityV3Middleware}.
 *
 ...
 */
export interface PerplexityV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link PerplexityV3MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V3 billing middleware instance for Perplexity.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createPerplexityV3Middleware<TTags extends DefaultTags>(
  options: PerplexityV3MiddlewareOptions<TTags>,
) {
