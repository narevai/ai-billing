...
import {
  createPerplexityV4Middleware,
  PerplexityV4UsageAccounting,
} from './language-model-v4-perplexity-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('PerplexityBillingMiddlewareV4 Integration', () => {
  ...
  const createResult = (
    ...
    usage: {
      ...
      } as PerplexityV4UsageAccounting,
    },
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generate-text sample', async () => {
      ...
      const middleware = createPerplexityV4Middleware({
