...
import { createAnthropicV4Middleware } from './language-model-v4-anthropic-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('AnthropicBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event', async () => {
      ...
      const middleware = createAnthropicV4Middleware({
