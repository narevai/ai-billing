...
/**
 * Computes total cost for a DeepSeek completion from {@link ModelPricing} and token usage.
 *
 ...
 * Reasoning tokens (deepseek-reasoner) use `internalReasoningTokens` when provided; otherwise completion rate.
 *
 ...
 * @internal
 */
export const calculateDeepSeekCost = (params: {
