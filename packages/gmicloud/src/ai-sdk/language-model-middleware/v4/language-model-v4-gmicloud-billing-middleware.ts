...
export interface GmicloudV4UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createGmicloudV4Middleware}.
 *
 ...
 */
export interface GmicloudV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link GmicloudV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for GMI Cloud.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createGmicloudV4Middleware<TTags extends DefaultTags>(
  options: GmicloudV4MiddlewareOptions<TTags>,
) {
