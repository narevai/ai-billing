...
} from './language-model-v3-gmicloud-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV3,
...
describe('GmicloudBillingMiddlewareV3 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createGmicloudV3Middleware({
      ...
      const rawUsage = baseResult.usage.raw as GmicloudV3UsageAccounting;
