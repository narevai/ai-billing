...
import {
  createAlibabaV4Middleware,
  AlibabaV4UsageAccounting,
} from './language-model-v4-alibaba-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('AlibabaBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createAlibabaV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as AlibabaV4UsageAccounting;
