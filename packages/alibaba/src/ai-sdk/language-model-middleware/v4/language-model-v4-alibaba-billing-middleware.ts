...
export interface AlibabaV4UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createAlibabaV4Middleware}.
 *
 ...
 */
export interface AlibabaV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link AlibabaV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for Alibaba.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createAlibabaV4Middleware<TTags extends DefaultTags>(
  options: AlibabaV4MiddlewareOptions<TTags>,
) {
