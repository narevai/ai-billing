...
import {
  createAzureV4Middleware,
  AzureV4UsageAccounting,
} from './language-model-v4-azure-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('AzureBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createAzureV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as AzureV4UsageAccounting;
