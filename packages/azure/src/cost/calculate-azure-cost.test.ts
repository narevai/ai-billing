...
describe('calculateAzureCost', () => {
  ...
  it('should default cacheReadTokens to 0 when omitted from usage', () => {
    const mockPricing: ModelPricing = {
      promptTokens: 0.000001,
      completionTokens: 0.000003,
    ...
    const result = calculateAzureCost({ pricing: mockPricing, usage });
    const resultWithExplicitZero = calculateAzureCost({
      pricing: mockPricing,
  ...
  it('should default cacheWriteTokens to 0 when omitted from usage', () => {
    const mockPricing: ModelPricing = {
    ...
    // Completion: 0.0000012 * 1e9 * 40 = 48,000 nanos
    // Cache read: 0.0000001 * 1e9 * 30 = 3,000 nanos
    // Cache write defaults to 0 tokens, so cache write cost is 0.
  ...
  it('should default reasoningTokens to 0 when omitted from usage', () => {
    const mockPricing: ModelPricing = {
      promptTokens: 0.0000002,
