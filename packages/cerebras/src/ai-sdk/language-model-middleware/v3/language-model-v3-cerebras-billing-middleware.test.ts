...
import {
  createCerebrasV3Middleware,
  CerebrasV3UsageAccounting,
} from './language-model-v3-cerebras-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV3,
...
describe('CerebrasBillingMiddlewareV3 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generate-text usage', async () => {
      ...
      const middleware = createCerebrasV3Middleware({
      ...
      const rawUsage = baseResult.usage.raw as CerebrasV3UsageAccounting;
