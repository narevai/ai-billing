...
export interface CerebrasV4UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createCerebrasV4Middleware}.
 *
 ...
 */
export interface CerebrasV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link CerebrasV4MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V4 billing middleware instance for Cerebras.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createCerebrasV4Middleware<TTags extends DefaultTags>(
  options: CerebrasV4MiddlewareOptions<TTags>,
) {
