...
import {
  createAmazonBedrockV4Middleware,
  AmazonBedrockV4UsageAccounting,
} from './language-model-v4-amazon-bedrock-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('AmazonBedrockBillingMiddlewareV4 Integration', () => {
  ...
  const createResult = (
    ...
    usage: {
      ...
      raw: {
        ...
        totalTokens: 857,
        serverToolUsage: {},
      } as AmazonBedrockV4UsageAccounting,
    },
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the captured generateText usage', async () => {
      ...
      const middleware = createAmazonBedrockV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as AmazonBedrockV4UsageAccounting;
