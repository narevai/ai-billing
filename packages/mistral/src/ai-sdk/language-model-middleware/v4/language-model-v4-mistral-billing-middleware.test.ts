...
import {
  createMistralV4Middleware,
  MistralV4UsageAccounting,
} from './language-model-v4-mistral-billing-middleware.js';
import {
  BillingEventSchema,
  MockLanguageModelV4,
...
describe('MistralBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event using the sample generate-text usage', async () => {
      ...
      const middleware = createMistralV4Middleware({
      ...
      const rawUsage = baseResult.usage.raw as MistralV4UsageAccounting;
