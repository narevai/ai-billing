...
export interface MistralV3UsageAccounting extends JSONObject {
...
/**
 * Configuration for {@link createMistralV3Middleware}.
 *
 ...
 */
export interface MistralV3MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link MistralV3MiddlewareOptions}. A `priceResolver` is required.
 * @returns A V3 billing middleware instance for Mistral.
 *
 * @example
 * ```ts
 ...
 * ```
 */
export function createMistralV3Middleware<TTags extends DefaultTags>(
  options: MistralV3MiddlewareOptions<TTags>,
) {
  return createV3BillingMiddleware<TTags>({
    ...
    buildEvent: async ({
      ...
      const mistralRawUsage = usage?.raw as MistralV3UsageAccounting | undefined;
