...
/**
 * Configuration for {@link createOpenAICompatibleV4Middleware}.
 *
 ...
 */
export interface OpenAICompatibleV4MiddlewareOptions<
 ...
 *
 * @typeParam TTags - The shape of the tags object, extending {@link DefaultTags}.
 * @param options - Billing options; see {@link OpenAICompatibleV4MiddlewareOptions}.
 * @returns A V4 billing middleware instance for the configured provider.
 *
 * @example
 ...
 * import { createOpenAICompatibleV4Middleware } from '@ai-billing/openai-compatible/v4';
 * import {
 *   consoleDestination,
 ...
 * ```
 */
export function createOpenAICompatibleV4Middleware<TTags extends DefaultTags>(
  options: OpenAICompatibleV4MiddlewareOptions<TTags>,
) {
