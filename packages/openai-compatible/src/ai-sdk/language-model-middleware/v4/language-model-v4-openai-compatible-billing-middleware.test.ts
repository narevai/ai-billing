...
import { createOpenAICompatibleV4Middleware } from './language-model-v4-openai-compatible-billing-middleware.js';
import {
  MockLanguageModelV4,
...
describe('OpenAICompatibleBillingMiddlewareV4 Integration', () => {
  ...
  describe('wrapGenerate', () => {
    it('should extract usage, resolve pricing, calculate cost, and broadcast event', async () => {
      ...
      const middleware = createOpenAICompatibleV4Middleware({
